...
from petstagram_2.pets.views import list_pets, pet_details, like_pet, create_pet, edit_pet, delete_pet, comment_pet

urlpatterns = [
    path('', list_pets, name='pet list'),
    path('details/<int:pk>', pet_details, name='pet details'),
    path('like/<int:pk>', like_pet, name='pet like'),

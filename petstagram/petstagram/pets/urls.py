...
from petstagram.pets.views import PetDetailsView, CommentPetView, \
    ListPetsView, CreatePetView, EditPetView, DeletePetView, LikePetView
...
urlpatterns = [
    ...
    path('edit/<int:pk>', EditPetView.as_view(), name='update pet'),
